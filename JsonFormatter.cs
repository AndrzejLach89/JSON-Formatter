...
namespace JsonFormatter
{
    ...
    static class JsonFormatter
    {
        ...
        /// <summary> Method used for formatting JSON from single-line text to multiline text, easily readable by human. Deletes unnecessary whitespaces. </summary>
        /// <param name="input"> Raw single-line JSON string; string </param>
        /// <returns> Formatted, human-readable JSON string </returns>
        public static string FormatJsonWhitespace(string input)
        {
            char[] entering = { '{', '[', '(' };
            char[] exiting = { '}', ']', ')' };
            bool inside = false;
        ...
        /// <param name="length"> Single level indent depth </param>
        /// <returns> Formatted, human-readable JSON string </returns>
        public static string FormatJsonWhitespace(string input, char symbol, int length)
        {
            IndentSymbol = symbol;
            IndentLength = length;
            return FormatJson(input);
        ...
        /// <param name="length"> Single level indent depth </param>
        /// <returns> Formatted, human-readable JSON string </returns>
        public static string FormatJsonWhitespace(string input, int length)
        {
            IndentLength = length;
            return FormatJson(input);
        }
        ...
        /// <param name="length"> Single level indent depth </param>
        /// <returns> Formatted, human-readable JSON string </returns>
        public static string FormatJsonWhitespace(string input, char symbol)
        {
            IndentSymbol = symbol;
            return FormatJson(input);
        }
